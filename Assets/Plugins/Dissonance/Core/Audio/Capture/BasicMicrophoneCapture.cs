...
namespace Dissonance.Audio.Capture
{
        ...
        : MonoBehaviour, IMicrophoneCapture
    {
        ...
        public WaveFormat StartCapture(string inputMicName)
        {
            ...
            Log.Info("Began mic capture (SampleRate:{0}, FrameSize:{1}, Buffer Limit:2^{2}, Latency:{3}ms, Device:{4})", _clip.frequency, frameSize, _maxReadBufferPower, Latency.TotalMilliseconds, _micName);
            return _format;
        }
